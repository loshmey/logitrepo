...
public class ObjectFactory {
    ...
    private final static QName _InvoiceRequest_QNAME = new QName("http://localhost:8080/holidayService/", "InvoiceRequest");
    private final static QName _InvoiceResponse_QNAME = new QName("http://localhost:8080/holidayService/", "InvoiceResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080/holidayService/", name = "InvoiceRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080/holidayService/", name = "InvoiceResponse")
